...
public void signuplink_click() throws InterruptedException
{
	...
	empsignup.statedropdown(prop.getProperty("State"));
	empsignup.companydetails(prop.getProperty("CompanyName"),prop.getProperty("CompanyAddress1"),prop.getProperty("CompanyAddress2"),prop.getProperty("CityName"),prop.getProperty("ZipCode"),prop.getProperty("FirstName"),prop.getProperty("LastName"),prop.getProperty("MiddleName"),prop.getProperty("Email"),prop.getProperty("PhoneNumber"));
